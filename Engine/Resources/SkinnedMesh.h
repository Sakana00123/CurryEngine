	...
	public:
		struct Skeleton
		{
			struct Bone
			{
				...
				void serialize(T& archive)
				{
					archive(id, name, parentIndex, nodeIndex, offsetTransform);
				}
			};
		...
		struct Mesh
		{
			...
			struct Subset
			{
				...
				void serialize(T& archive)
				{
					archive(materialId, materialName, startIndexLocation, indexCount);
				}
			};
			...
			void serialize(T& archive)
			{
				archive(id, name, nodeIndex, vertices, indices, subsets, defaultGlobalTransform,
		...
		struct Material
		{
			...
			void serialize(T& archive)
			{
				archive(id, name, Ka, Kd, Ks, texture_filenames);
			}
		};
