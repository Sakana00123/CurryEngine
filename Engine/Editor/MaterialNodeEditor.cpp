...
bool MaterialNodeEditor::IsOpen()
{
	return s_isOpen;
}

void MaterialNodeEditor::OpenAsset(const std::filesystem::path& path)
{
...
void MaterialNodeEditor::DrawGUI()
{
#ifdef USE_IMGUI
	if (!s_isOpen) return;
...
void MaterialNodeEditor::NodeEditorInitialize()
{
	// ImNodesのコンテキストを作成
...
void MaterialNodeEditor::NodeEditorShutdown()
{
...
void MaterialNodeEditor::DrawNodeEditor(NodeEditorState& state)
{
