...
void Profiler::DrawUI()
{
    if (m_isWindowOpen)
    {
        ...
        unsigned int frameRectColor = 0xFFFFFFFF;
        unsigned int frameNoInfoRectColor = 0xCCFFFFFF;
        ...
        ImGui::Begin("Profiler", &m_isWindowOpen, ImGuiWindowFlags_NoScrollWithMouse);
